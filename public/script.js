...
// Comunicação com API REST /produtos
// =============================================
...
async function carregarProdutos() {
  ...
  try {
    ...
    mostrarMensagem('Erro ao carregar produtos. Verifique se o servidor está rodando.', 'erro');
  }
}
...
async function deletarProduto(id) {
  ...
  try {
    ...
    if (!resposta.ok) {
      const erro = await resposta.json();
      throw new Error(erro.mensagem || 'Erro ao deletar produto');
    }
